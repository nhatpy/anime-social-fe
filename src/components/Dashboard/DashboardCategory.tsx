...
const dataSource = [
    ...
    { key: "6", name: "Tình cảm", description: "description description 1" },
    { key: "7", name: "Hài hước", description: "description description 1" },
    { key: "8", name: "Phiêu lưu", description: "description description 1" },
    { key: "9", name: "Hầm ngục", description: "description description 1" },
    { key: "10", name: "Học trò", description: "description description 1", },
  ];
  const content = (
    <div className="flex flex-row gap-2">
      <Button className="text-purple-400" type="text">Sửa{icons.update}</Button>
  ...
  const columns = [
    ...
    },
    {
      ...
      key: 'description',
      render: (description: string) => <p className="w-[300px] truncate">{description}</p>
    },
    {
      title: "Hành động",
      key: "action",
    ...
    return (
        <div className="flex flex-col gap-4 w-full h-full">
            <div className='flex flex-row justify-between items-center w-full'>
                ...
                <Button type="primary" onClick={()=>{setIsModalOpen(true)}}>{icons.create}</Button>
            </div>
