...
const dataSource = [
  ...
  { key: "2", img: "/assets/images.jpg", title: "Bách Luyện Thành Thần", numberOfChapter: "Chapter 1264", views: "41M", isVerified: false },
  ...
  { key: "5", img: "/assets/images.jpg", title: "Đại Quân Gia Là Ma Hoàng", numberOfChapter: "Chapter 659", views: "469K", isVerified: true },
];

const content = (
  <div className="flex flex-row gap-2">
    <Button className="text-blue-600" type="text">Sửa{icons.create}</Button>
