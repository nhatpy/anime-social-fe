...
const content = (
  <div className="flex flex-row gap-2">
    <Button className="text-amber-400" type="text">
...
const columns = [
  ...
  },
  {
    ...
    render: (fullName: string) => (
      <p className="w-[100px] truncate">{fullName}</p>
    ),
  },
  {
    title: "Linh thạch",
    ...
    key: "gem",
    render: (gem: string) => (
      <p className="flex justify-center items-center text-pink-600">
        {gem}
        {icons.diamond}
      </p>
    ),
...
export const DashboardManageUser = () => {
  return (
    <div className="flex flex-col gap-4 w-full h-full">
      <h2 className="text-3xl font-bold text-blue-800">Quản lý người dùng</h2>
