      ...
      <div className="flex flex-row gap-1 w-full">
        ...
        <div className="flex flex-col gap-1 w-[60%]">
          <p>
            ...
            Chuyển sinh, Manhua, Truyện màu, Tu tiên
          </p>
          <p>
          ...
          <p>
            <span className="font-semibold text-blue-800">Lượt xem: </span>100K
          </p>
          <p>
            <span className="font-semibold text-blue-800">Bình luận: </span>200
          </p>
          <p>
            <span className="font-semibold text-blue-800">Theo dõi: </span>76K
          </p>
          <p>
            <span className="font-semibold text-blue-800">Ngày cập nhật: </span>
            30/12/2024
          </p>
        </div>
      </div>
      <div>
        Ngu Tử Du bị chết sặc rồi chuyển sinh thành một cây liễu đột biến và bắt
      ...
      <div className="flex flex-col gap-2 w-full h-fit p-2">
        ...
        <div className="flex flex-col justify-evenly items-center w-full">
          <div className="flex flex-row justify-between items-center w-full">
            <span>Chap 1</span>{" "}
            <span className="text-xs text-gray-400 italic">30/12/2024</span>
          </div>
          <div className="flex flex-row justify-between items-center w-full">
            <span>Chap 2</span>{" "}
            <span className="text-xs text-gray-400 italic">30/12/2024</span>
