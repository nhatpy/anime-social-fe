            ...
            <div className="w-[60%] h-full flex flex-col justify-center items-center bg-white p-5 gap-5">
                <Form onFinish={handleSubmit(onSubmit)} className="flex flex-col gap-2 w-full mt-4">
                    ...
                    <div className='w-full flex flex-col justify-center items-center'>
                            ...
                            render={({ field }) => (                                
                                <div className='w-full flex flex-col justify-center items-center'>
                                    <div className='flex flex-col w-1/3 gap-2'>
                                        <label htmlFor="email" className="text-base text-left font-medium text-red-600">*Email</label>
                                        <Input
                                            id="email"
                                            prefix={icons.create}
                                            {...field}
                        ...
                        />
                        <Button htmlType='submit' disabled={isDisabled} type='primary' className='w-[100px]'>
